...
public class ReservationRestController {
    ...
    public ResponseEntity<Map<String, Object>> addReservationInfo(@RequestBody ReservationDTO reservationDTO) throws NotFoundUserException {
        ...
        Reservation reservation = ReservationDTO.toEntity(reservationDTO, user.get());

        Map<String, Object> response = getResponseMap(reservationService.addReservationInfo(reservation));
    ...
    private Map<String, Object> getResponseMap(Reservation reservation){
        ...
        if (reservation.getInspectionItem01() != null){
            response.put("inspection_item01", reservation.getInspectionItem01());
        }
        if (reservation.getInspectionItem02() != null){
            response.put("inspection_item02", reservation.getInspectionItem02());
        }
        if (reservation.getInspectionItem03() != null){
            response.put("inspection_item03", reservation.getInspectionItem03());
        }
        return response;
    }
